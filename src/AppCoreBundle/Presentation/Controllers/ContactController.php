...
class ContactController extends BaseController {
   ...
   */
    public function indexAction(Request $request){
      ...
      if ($request->isXmlHttpRequest()) return $grid->getGridResponse('AppCoreBundle:Contact:indexAjax.html.twig');
      if ($grid->isReadyForRedirect())return new RedirectResponse($grid->getRouteUrl());
      return $grid->getGridResponse('@AppCoreBundle/Contact/index.html.twig');
    }
