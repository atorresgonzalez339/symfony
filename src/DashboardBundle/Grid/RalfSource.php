...
abstract class RalfSource implements DriverInterface
{
    ...
    */
    ...
    {
        return $this->getTotal();//; $maxResults === null ? $this->count : min($this->count, $maxResults);
    }
    ...
    private function removeAccents($str)
    {
        ...
        return $str;// preg_replace('#&([A-za-z]{2})(?:lig);#', '\1', $noaccentStr);
    }
